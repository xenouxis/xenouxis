<?php 
    ...
    if(isset($_GET['delete']))
    {
        ...
        $reqdel = $bdd->prepare("SELECT * FROM infographie WHERE id=?");
...
<body>
    ...
    <div class="container-fluid">
     ...
     <a href="addAnimation.php" class="btn btn-primary">Ajouter une animation</a>
     <?php 
        if(isset($_GET['add']))
        {
    ...
    ?>
     <table class="table table-striped">
        ...
        <tbody>
            <?php 
                $req = $bdd->query("SELECT * FROM infographie");
                while($don = $req->fetch())
                {
                    echo "<tr>";
                        echo "<td>".$don['id']."</td>";
                        ...
                        echo "<td>".$don['date']."</td>";
                        echo "<td>";
                            echo "<a href='updateAnimation.php?id=".$don['id']."' class='btn btn-warning'>Modifier</a>";
                            echo "<a href='animation.php?delete=".$don['id']."' class='btn btn-danger'>Supprimer</a>";
                        echo "</td>";
                    echo "</tr>";
                }
                $req->closeCursor();
