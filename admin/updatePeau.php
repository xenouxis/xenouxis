<?php 
    ...
    if(isset($_GET['delete']))
    {
        ...
        if(!$dondel = $reqdel->fetch())
        {
            ...
            header("LOCATION:updatePeau.php?id=".$id);
        }
        ...
        $delete->closeCursor();
        header("LOCATION:updatePeau.php?id=".$id."&delsuccess=".$idImg);
...
<body>
    ...
    <div class="container">
        ...
        <a href="peau.php" class='btn btn-secondary'>Retour</a>
        <?php
            if(isset($_GET['error']))
            {
        ...
        ?>
        <form action="treatmentUpdatePeau.php?id=<?= $don['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
