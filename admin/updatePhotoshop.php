<?php 
    ...
    if(isset($_GET['delete']))
    {
        ...
        if(!$dondel = $reqdel->fetch())
        {
            ...
            header("LOCATION:updatePhotoshop.php?id=".$id);
        }
        ...
        $delete->closeCursor();
        header("LOCATION:updatePhotoshop.php?id=".$id."&delsuccess=".$idImg);
...
<body>
    ...
    <div class="container">
        ...
        <a href="photoshop.php" class='btn btn-secondary'>Retour</a>
        <?php
            if(isset($_GET['error']))
            {
        ...
        ?>
        <form action="treatmentUpdatePhotoshop.php?id=<?= $don['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
