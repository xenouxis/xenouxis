<?php 
    ...
    if(isset($_GET['delete']))
    {
        ...
        if(!$dondel = $reqdel->fetch())
        {
            ...
            header("LOCATION:updateIllustrator.php?id=".$id);
        }
        ...
        $delete->closeCursor();
        header("LOCATION:updateIllustrator.php?id=".$id."&delsuccess=".$idImg);
...
<body>
    ...
    <div class="container">
        ...
        <a href="illustrator.php" class='btn btn-secondary'>Retour</a>
        <?php
            if(isset($_GET['error']))
            {
        ...
        ?>
        <form action="treatmentUpdateIllustrator.php?id=<?= $don['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
